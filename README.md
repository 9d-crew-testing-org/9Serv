...
9Serv aims to provide a mostly functioning WebTV server with less complexity and a pure Python codebase, hopefully making hosting a custom WebTV Server easier and more accessible.
## Quick Start
